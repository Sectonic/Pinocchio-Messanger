    ...
    <div data-theme="winter" className="h-screen w-screen overflow-hidden flex justify-center items-center bg-primary-content">
        <div className="mockup-browser border bg-primary w-[600px]">
            ...
            <div className="bg-base-100 py-2">
              <div className="p-3 mx-2 px-3 bg-base-100 h-[35vh] 2xl:h-[50vh] overflow-y-scroll scrollbar-thin scrollbar-thumb-primary scrollbar-track-transparent scrollbar-thumb-rounded-xl">
            ...
            <div className="py-4 px-4 2xl:px-6 bg-base-200">
                { chatFinished ? (
                  ...
                  <>
                    {allResponses ? (
                      <div className="flex justify-between items-center text-sm py-2 ml-1 font-semibold opacity-80">
                        Select a response and submit
                        <div className="btn-square btn-sm btn btn-primary" onClick={submitResponse}>
                      ...
                      <div className="text-sm py-2 ml-1 font-semibold opacity-80">
                        Loading...
                      </div>
                    )}
                    <ResponsePicker
